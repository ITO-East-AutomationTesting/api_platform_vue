<template>
    <div class="test">
        <div style="margin: 10px;padding-left: 10px">
            ...
            <el-button type="primary" @click.native="generatePhoneNumber()" size="small">生成手机号码</el-button>
    ...
    export default {
        ...
        methods: {
            ...
            buildIdentity() {
                ...
                this.$axios.get(this.$api.buildIdentify, {}).then((response) => {
            ...
            generatePhoneNumber() {
                this.$axios.get(this.$api.generatePhoneNumber, {}).then((response) => {
