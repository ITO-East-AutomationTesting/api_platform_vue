      ...
      <div class="page-login--content" flex="dir:top main:justify cross:center box:justify">
        <div class="page-login--content-main" flex="dir:top main:center cross:center">
          ...
          <div class="page-login--form">
            <div class="page-login--content-footer" align="center">
              <span class="background-logo" style="color: #fff; font-size:25px; 
              font-family:az_ea_font,'Segoe UI',wf_segoe-ui_semibold,'Segoe UI Semibold','Segoe WP Semibold','Segoe WP',Tahoma,Arial,sans-serif">Wicresoft Test Platform</span>
            </div>
            <el-card shadow="never">
              <el-form ref="loginForm" label-position="top" size="default">
                ...
                <el-button size="default" @click.native="login()" type="primary" class="button-login" round>登录</el-button>
              </el-form>
            </el-card>
          </div>
        </div>
          ...
          if (response.data["status"] === 0) {
            ...
            if (this.token) {
              ...
              let redirect = decodeURIComponent(
                this.$route.query.redirect || "/manage/projectManage"
              );
